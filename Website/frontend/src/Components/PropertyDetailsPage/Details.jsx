            ...
            <Card.Body>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <Card.Text>
                  ...
                  <i className="fa-solid fa-map-marker-alt"></i> {item.location}
                  , {item.CITY}
                </Card.Text>
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <Card.Title>
                  RERA Reg. No : {item.RERA_Registration_Number}
                </Card.Title>
          ...
          <Card className="mb-3" style={{ border: "1px solid purple" }}>
            <Card.Body>
              ...
              <div>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-solid fa-building-wheat"></i> Property :
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-regular fa-compass"></i> Facing :
                  </Col>
                  <Col xs={6} className="text-end">
                ...
                >
                  <Col xs={6}>
                    <i className="fa-solid fa-bed"></i> Bedrooms :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.BEDROOM_NUM}
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-solid fa-tree"></i> Balcony :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.BALCONY_NUM}
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-solid fa-chart-area"></i> Total Area :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.AREA} sq. ft.
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-solid fa-tags"></i> Price per sq.ft :
                  </Col>
                  <Col xs={6} className="text-end">
                ...
                >
                  <Col xs={6}>
                    <i className="fa-solid fa-building"></i> Floor :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.FLOOR_NUM} of {item.TOTAL_FLOOR}
                  </Col>
                </Row>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-brands fa-pagelines"></i> Age :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.AGE}
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i className="fa-solid fa-car"></i> Parking Available :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.Visitor_Parking ? "Yes" : "No"}
                  </Col>
                </Row>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-solid fa-couch"></i> Furnish :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.FURNISH}
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i class="fa-solid fa-person-digging"></i> Situation :
                  </Col>
                  <Col xs={6} className="text-end">
                    {item.Situation}{" "}
                  </Col>
                ...
                >
                  <Col xs={6}>
                    <i className="fa-solid fa-money-bills"></i> Price :
                  </Col>
                  <Col xs={6} className="text-end">
                    ETB
                    {item.PRICE > 1
                      ? `${item.PRICE.toFixed(2)} `
                      : `${(item.PRICE * 100).toFixed(2)} Lakh`}
                  </Col>
                </Row>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <Col xs={6} className="text-end">
                    {item.Swimming_Pool ? "Available" : "N/A"}
                  </Col>
                </Row>
                ...
                >
                  ...
                  <Col xs={6} className="text-end">
                    {item.Visitor_Parking ? "Available" : "N/A"}{" "}
                  </Col>
                </Row>
                ...
                >
                  ...
                  <Col xs={6} className="text-end">
                    {item.Intercom_Facility ? "Available" : "N/A"}{" "}
                  </Col>
                </Row>
                ...
                >
                  ...
                  <Col xs={6} className="text-end">
                    {item.Power_Backup ? "Available" : "N/A"}
                  </Col>
                </Row>
                ...
                >
                  ...
                  <Col xs={6} className="text-end">
                    {item.Fire_Safety_Installed ? "Yes" : "No"}
                  </Col>
                </Row>
              </div>
              ...
              <div>
                ...
                >
                  <Col xs={6}>EMI :</Col>
                  <Col xs={6} className="text-end">
                    {item.Estimated_Monthly_EMI
                      ? `ETB${item.Estimated_Monthly_EMI}`
                      : "N/A"}
                  </Col>
                </Row>
                <Row
