...
const SearchResult = () => {
  ...
  const { data } = useSelector(
    (state) => state.searchResult || { data: { result: [] } }
  );
          ...
          data.result.length === 0 ? null : (
            <div style={{ padding: "20px" }}>
              <h4 style={{ marginBottom: "20px", color: "#000" }}>
                Search Result for {data.result[0].location} :
              </h4>
              <Row>
                          ...
                          <Card.Body style={{ padding: "20px" }}>
                            ...
                            >
                              <div>
                                ...
                                >
                                  {flat.BEDROOM_NUM} BHK {flat.PROPERTY_TYPE} in{" "}
                                  {flat.location}
                                </Card.Subtitle>
                              </div>
                              <Button
                            ...
                            <div style={{ marginTop: "15px" }}>
                              <h5
                                style={{ fontSize: "1.5rem", color: "#e0e0e0" }}
                              >
                                ETB
                                {flat.PRICE > 1
                            ...
                            <p style={{ marginTop: "10px", color: "#bbb" }}>
                              ...
                              <br />
                              <strong>{flat.BEDROOM_NUM} BHK</strong>,{" "}
                              {flat.BALCONY_NUM} Balconies | {flat.Situation}
                            </p>
                            ...
                            >
                              ...
                              <Button
                                onClick={() =>
                                  (window.location.href = `tel:${flat.Contact}`)
                                }
                              >
                                <i
