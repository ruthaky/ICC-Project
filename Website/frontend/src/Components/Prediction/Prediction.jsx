  ...
  const fetchData = async (sessionId) => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_DJANGO_API_URL}fetchdata/?session_id=${sessionId}`
      );
  ...
  const formHandler = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_DJANGO_API_URL}submit/`,
        formData
      );
                    ...
                    <Col className="mb-3">
                      ...
                      <div className="mb-3">
                        <Form.Check
                          ...
                          value="New Property"
                          onChange={selectAge}
                          checked={age === "New Property"}
                          required
                        />
                        <Form.Check
                          inline
                          label="Relatively New"
                          type="radio"
                          name="age"
                          value="Relatively New Property"
                          onChange={selectAge}
                          checked={age === "Relatively New Property"}
                          required
                        />
                        <Form.Check
                          inline
                          label="Moderately Old"
                          type="radio"
                          name="age"
                          value="Moderately Old"
                          onChange={selectAge}
                          checked={age === "Moderately Old"}
                          required
                        />
                        <Form.Check
                          inline
                      ...
                      <div className="mb-3">
                        <Form.Check
                          ...
                          name="furnish"
                          value="Unfurnished"
                          onChange={selectFurnish}
                          checked={furnish === "Unfurnished"}
                          required
                        />
                        ...
                        <Form.Check
                          ...
                          onChange={selectFurnish}
                          checked={furnish === "Semi-furnished"}
                          required
                        />
                        ...
                        <Form.Check
                          ...
                          onChange={selectFurnish}
                          checked={furnish === "Luxury furnished"}
                          required
                        />
                        ...
                        <Form.Check
                          ...
                          onChange={selectFurnish}
                          checked={furnish === "Fully furnished"}
                          required
                        />
                      </div>
                    ...
                    data.prediction !== undefined ? (
                      <div>
                        <p className="text-center mt-4">
                          ...
                          <span>
                            {data.prediction > 1
                              ? `${(data.prediction - 0.13).toFixed(2)} to ${(
                                  data.prediction + 0.13
                                ).toFixed(2)} `
                              : data.prediction + 0.13 > 1
                              ? `${(data.prediction - 0.13).toFixed(2)} to ${(
                                  data.prediction + 0.13
                                ).toFixed(2)} `
                              : `${((data.prediction - 0.13) * 100).toFixed(
                                  2
                                )} to ${(
                                  (data.prediction + 0.13) *
                                  100
                        ...
                        {area && !isNaN(area) && area > 0 ? (
                          <p className="text-center">
                            ...
                            <span>
                              Rs.{" "}
                              {Math.round((data.prediction * 10000000) / area)}
                              /-
                            </span>
                          </p>
                        ) : (
